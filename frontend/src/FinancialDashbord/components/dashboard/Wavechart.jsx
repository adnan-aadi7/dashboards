...
export default function ScalingChart() {
  ...
  return (
    <div className="rounded-2xl border border-[#252B42] text-white w-full h-full">
      {/* Top legend */}
      <div className="px-3 py-1.5 flex items-center justify-between">
        <div className="text-xs tracking-wide">3 MONTHS BACK 3 MONTHS FORECAST PROGNOSE</div>
