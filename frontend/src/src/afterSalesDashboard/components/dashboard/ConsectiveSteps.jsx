...
// SummaryTall extracted to dedicated components TotalPilar and AfterSalesPilar
  ...
  return (
    <div className="flex flex-col xl:flex-row items-start  sm:gap-3 ">
      ...
      <section className="flex-shrink-0 w-full xl:w-auto">
      <div className="  ">
        <div className=" sm:p-4  bg-[#090D28] rounded-2xl">
          <div className="px-1 sm:px-2 pb-2 sm:pb-3 lg:pb-4">
          ...
          <div className="flex gap-2 sm:gap-3 md:gap-4 lg:gap-6 xl:gap-8 overflow-x-auto no-scrollbar">
            {/* Steps */}
            <div className="flex gap-2 sm:gap-3 md:gap-4 lg:gap-5">
              {steps.map((card) => (
           <div key={card.title} className="flex flex-col w-[70px] pt-2 pb-3 bg-[#181C3A] rounded-xl">
