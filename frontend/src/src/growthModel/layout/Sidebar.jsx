...
const Sidebar = ({ sidebarOpen, onSidebarClose }) => {
  ...
  const icons = useMemo(() => [
    { id: "stats", src: "/icons/stats.png", alt: "stats", path: "/growthmodel/dashboard" },
    { id: "search", src: "/icons/search.png", alt: "search", path: "/growthmodel/search" },
    { id: "file", src: "/icons/file.png", alt: "file", path: "/growthmodel/files" },
  ], []);
